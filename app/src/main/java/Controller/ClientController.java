...
public class ClientController {
    ...
    public static void insertNewTestResult(StatisticModel statisticModel,long clientId){
        ...
        String query = "INSERT INTO Statistics(FID,Points,Time,Success,maxPoints,limitPoint) VALUES (" +
                       clientId + "," + statisticModel.getReachedPoints() + ",'" +statisticModel.getTime() + "'," +
                        statisticModel.getSuccess() + "," + statisticModel.getMaxPoints() + "," + statisticModel.getMinReachPoints() + ")";
    ...
    public static ArrayList<StatisticModel> getClientStatistic(int id){
        try{

            ArrayList<StatisticModel> list = new ArrayList<StatisticModel>();
            String query = "SELECT * FROM Statistic WHERE FID = " + id ;
